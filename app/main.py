...
from app.api.routes.course_management_router import CourseManagementRouter
...
def create_app() -> FastAPI:
    ...
    course_mgmt_router = CourseManagementRouter()
    app.include_router(course_mgmt_router.router, prefix="/api/v1", tags=["Course Management"])
